  ...
  return (
    <div className="relative overflow-hidden min-h-[calc(100vh-6rem)]">
      ...
      <div className="container mx-auto px-4 sm:px-6 min-h-[calc(100vh-6rem)] grid grid-cols-1 md:grid-cols-[1fr_minmax(0,420px)_1fr] items-center gap-6 md:gap-4 py-12 md:py-0">
        ...
        {/* ── LEFT: Introduction ── */}
        <motion.div
          className="flex flex-col items-start z-10 space-y-5 order-1 md:order-1"
        ...
        {/* ── CENTER: Cube ── */}
        <div className="order-2 md:order-2 flex items-center justify-center w-full">
          <div
        ...
        <div
          ref={rightColRef}
          className="order-3 md:order-3 hidden md:flex flex-col items-end justify-center overflow-hidden"
        >
          <h2
